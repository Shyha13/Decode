...
public class CloseSideAutoRIP extends OpMode {
    private ElapsedTime timer;
    private DashboardPoseTracker dashboardPoseTracker;
    private Robot robot;
    private CloseSideAutoRIPPaths paths;
    private SequentialCommandGroup auto;
    private String color;

    public CloseSideAutoRIP(String color) {
        this.color = color;
    }
    ...
    public void init() {
        ...
        paths = new CloseSideAutoRIPPaths(robot.follower, color);
    ...
    public static class CloseSideAutoRIPPaths {
        public PathChain Path1, Path2, Path3, Path4, Path5;
        public PathChain LeverPath, LeverPath2, LeverIntakePath, LeverReturnPath, LeverIntakePath2, LeverReturnPath2, LeverPath3, LeverReturnPath3, LeverIntakePath3;

        public CloseSideAutoRIPPaths(Follower follower, String color) {
...
//                    .setLinearHeadingInterpolation(Math.toRadians(heading180), Math.toRadians(heading180))
            ...
            Path5 = follower.pathBuilder()
                    .addPath(new BezierLine(firstIntake, finalShootingPose))
                    .setTangentHeadingInterpolation()
                    .setReversed(true)
                    .build();
        }
