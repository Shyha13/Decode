...
public class AutoConstants {
    ...
    public static double leverHeading = 149;
    public static double secondIntakeY = 62;
    public static double shootingX = 64;
    public static double shootingY = 80;
    public static double firstIntakeX = 18;
    public static double secondIntakeX = 14;
    public static int leverIntakeBallWait = 1000;
    public static double leverPoseX = 35; //control point
    public static double leverPoseY = 59; //control point
    public static double startX = 20.49;
    public static double startY = 124.47;
    public static double leverX = 14;
    public static double leverY = 61.5;
